                            ...
                            <tr class="event-row">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('admin.events.show', $event) }}" class="action-btn view-btn"
                                            title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.events.edit', $event) }}" class="action-btn edit-btn"
                                            title="Edit Event">
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <a href="{{ route('admin.events.create') }}" class="btn-create-event-empty">
    ...
    <script>
        ...
        function updateEventStatus(eventId, status) {
            return new Promise((resolve, reject) => {
                fetch(`${baseUrl}/admin/events/${eventId}/update-status`, {
                        method: 'POST',
                        headers: {
        ...
        function toggleFeature(eventId) {
            return new Promise((resolve, reject) => {
                fetch(`${baseUrl}/admin/events/${eventId}/toggle-feature`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
        ...
        function togglePublish(eventId) {
            return new Promise((resolve, reject) => {
                fetch(`${baseUrl}/admin/events/${eventId}/toggle-publish`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '{{ csrf_token() }}'
