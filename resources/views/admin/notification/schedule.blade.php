        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.notifications.schedule.store', $notification) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group mt-3">
                                ...
                                <small class="form-text text-muted">Local time will be interpreted according to the server
                                    timezone ({{ config('app.timezone') }}).</small>
                            </div>
