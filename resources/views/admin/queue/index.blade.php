        ...
        <div class="row mb-4">
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between mt-3">
                    <a href="{{ route('admin.queue.dashboard') }}" class="btn btn-info">
                        <i class="fas fa-tv"></i> Live Dashboard
                    </a>
                    <a href="{{ route('admin.queue.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($queues as $queue)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.queue.show', $queue) }}" class="btn btn-sm btn-info">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.queue.edit', $queue) }}" class="btn btn-sm btn-warning">
