    ...
    <div class="modal fade" id="addRoomTypeModal" tabindex="-1" aria-labelledby="addRoomTypeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="addRoomTypeForm" action="{{ route('admin.room-types.store') }}" method="POST">
                    @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-room-type', function() {
                ...
                var url = "{{ route('admin.room-types.edit', ':id') }}".replace(':id', roomTypeId);
                var updateUrl = "{{ route('admin.room-types.update', ':id') }}".replace(':id', roomTypeId);
