                        ...
                        @foreach ($beds as $key => $bed)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.beds.destroy', $bed->id) }}" method="POST"
    ...
    <div class="modal fade" id="bedModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="bedForm" method="POST" action="{{ route('admin.beds.store') }}">
                    @csrf
    ...
    <script>
        ...
        $('#bedModal').on('show.bs.modal', function(e) {
            if (!$(e.relatedTarget).hasClass('editBed')) {
                $('#bedForm')[0].reset();
                $('#formMethod').html('');
                // ✅ baseUrl prepend karo
                $('#bedForm').attr('action', `${baseUrl}/admin/beds`);
        ...
        $('.editBed').click(function() {
            ...
            // ✅ baseUrl prepend karo
            $('#bedForm').attr('action', `${baseUrl}/admin/beds/${id}`);
