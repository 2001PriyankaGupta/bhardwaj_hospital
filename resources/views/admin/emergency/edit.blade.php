            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.emergency.show', $emergency) }}" class="btn btn-info btn-sm">
                            <i class="fas fa-eye"></i> View Details
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.emergency.update', $emergency) }}" method="POST">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('doctor_id') is-invalid @enderror" id="doctor_id"
                                            ...
                                            @foreach ($doctor as $doc)
                                                <option value="{{ $doc->id }}"
                                                    {{ $emergency->doctor_id == $doc->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('admin.emergency.show', $emergency) }}"
                        ...
                        <!-- Delete Form -->
                        <form id="delete-form" action="{{ route('admin.emergency.destroy', $emergency) }}"
