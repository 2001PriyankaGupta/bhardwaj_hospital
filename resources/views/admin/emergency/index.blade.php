                                ...
                                <tr
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.emergency.show', $case) }}" class="btn btn-info"
                                                title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.emergency.edit', $case) }}" class="btn btn-primary"
                                                title="Edit">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.assign-staff-btn').click(function() {
                ...
                form.attr('action', `${baseUrl}/admin/emergency/${caseId}/assign-staff`);
