...
@section('content')
    <style>
        ...
        .profile-sidebar {
            background: linear-gradient(to bottom, #ff4900, #fcfdfe);
            color: white;
            padding: 30px;
            text-align: center;
            height: 100%;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            saveAvatarBtn.addEventListener('click', function() {
                ...
                fetch('{{ route('doctor.profile.update-avatar') }}', {
                        method: 'POST',
                        body: formData
                    })
            ...
            passwordForm.addEventListener('submit', function(e) {
                ...
                // Send AJAX request
                fetch('{{ route('doctor.profile.change-password') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
