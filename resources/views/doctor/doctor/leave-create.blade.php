...
@section('title', 'Apply for Leave - Dr. ' . $doctor->full_name)
                ...
                <div class="card">
                    <div class="card-header text-black">
                        <h5 class="card-title mb-0">
                            <i class="fas fa-calendar-plus mr-2 text-black"></i> Apply for Leave - Dr.
                            {{ $doctor->full_name }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('doctor.leave.store', $doctor) }}" method="POST" id="leaveForm">
                                    @csrf
