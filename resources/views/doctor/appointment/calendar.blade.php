        ...
        <div class="container-fluid py-3 bg-white border-bottom">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-end">
                    ...
                    {{-- <a class="btn btn-primary btn-sm me-2" href="{{ route('doctor.appointments.create') }}">
                        <i class="fas fa-plus-circle"></i> New Appointment
                    </a> --}}
                    <a class="btn btn-outline-secondary btn-sm" href="{{ route('doctor.appointments.index') }}">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                dateClick: function(info) {
                    window.location.href = baseUrl + '/admin/appointments/create?date=' + info.dateStr;
                },
