            ...
            <div class="col-md-8">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('doctor.emergency.edit', $emergency) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="{{ route('doctor.emergency.index') }}" class="btn btn-secondary btn-sm">
            ...
            <div class="col-md-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('doctor.emergency.update-status', $emergency) }}" method="POST">
                            @csrf
                            <div class="form-group">
                        ...
                        @if ($emergency->status != 'completed')
                            <hr>
                            <form action="{{ route('doctor.emergency.update', $emergency) }}" method="POST"
                                class="mb-3">
                                @csrf
                                @method('PUT')
