            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('doctor.emergency.show', $emergency) }}" class="btn btn-info btn-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('doctor.emergency.update', $emergency) }}" method="POST">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a href="{{ route('doctor.emergency.show', $emergency) }}"
                        ...
                        <!-- Delete Form -->
                        <form id="delete-form" action="{{ route('doctor.emergency.destroy', $emergency) }}"
