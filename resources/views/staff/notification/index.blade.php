            ...
            <div class="col-md-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('staff.notifications.create') }}" class="btn btn-primary-custom">
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-buttons">
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route('staff.notifications.edit', $template) }}"
                                                        class="btn btn-warning btn-sm me-1" title="Edit">
                                                        <i class="fas fa-edit" style="color: white;"></i>
                                                    </a>
                                                    <a href="{{ route('staff.notifications.schedule', $template) }}"
                                                        class="btn btn-info btn-sm me-1" title="Schedule">
                                                        <i class="fas fa-clock" style="color: white;"></i>
                                                    </a>
                                                    <form action="{{ route('staff.notifications.destroy', $template) }}"
                                                        method="POST"
                                        ...
                                        <tr>
                                            <td colspan="5">
                                                <div class="empty-state">
                                                    ...
                                                    <a href="{{ route('staff.notifications.create') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($message->status == 'pending')
                                                    <form action="{{ route('staff.scheduled-messages.cancel', $message) }}"
                                                        method="POST"
