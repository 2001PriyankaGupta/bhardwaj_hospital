...
@section('content')
    <div class="form-container">
        ...
        <div class="form-header">
            <div class="header-content">
                ...
                <p class="form-subtitle">
                    Add new hospital event, blood donation camp, or awareness program
                </p>
            </div>
        ...
        <!-- Main Form -->
        <div class="form-card">
            <form action="{{ route('staff.events.store') }}" method="POST" enctype="multipart/form-data" id="event-form"
                class="event-form">
                @csrf
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select id="type" name="type" class="form-control" required>
                                    ...
                                    <option value="blood_donation" {{ old('type') == 'blood_donation' ? 'selected' : '' }}>
                                        Blood Donation Camp</option>
                                    <option value="health_camp" {{ old('type') == 'health_camp' ? 'selected' : '' }}>Health
                                        Checkup Camp</option>
                                    <option value="awareness" {{ old('type') == 'awareness' ? 'selected' : '' }}>Awareness
                                        Program</option>
                                    <option value="seminar" {{ old('type') == 'seminar' ? 'selected' : '' }}>Medical Seminar
                                    </option>
                                    <option value="workshop" {{ old('type') == 'workshop' ? 'selected' : '' }}>Workshop
                                    </option>
                                    <option value="conference" {{ old('type') == 'conference' ? 'selected' : '' }}>
                                        Conference</option>
                                    <option value="charity" {{ old('type') == 'charity' ? 'selected' : '' }}>Charity Event
                                    </option>
                                    <option value="screening" {{ old('type') == 'screening' ? 'selected' : '' }}>Health
                                        Screening</option>
                                </select>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="description" name="description" rows="4" class="form-control"
                                placeholder="Describe the event details, objectives, and benefits..." required>{{ old('description') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="date-input">
                                <input type="date" id="event_date" name="event_date"
                                    value="{{ old('event_date', date('Y-m-d')) }}" class="form-control" required>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="venue" name="venue" value="{{ old('venue') }}"
                                class="form-control" placeholder="e.g., Hospital Main Auditorium" required>
                            @error('venue')
                                <div class="form-error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="address" name="address" value="{{ old('address') }}"
                                class="form-control" placeholder="Street, City, State">
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="requirements" name="requirements" rows="3" class="form-control"
                                placeholder="Any special requirements, instructions, or notes...">{{ old('requirements') }}</textarea>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="organizer" name="organizer" value="{{ old('organizer') }}"
                                class="form-control" placeholder="e.g., Hospital Administration">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="contact_number" name="contact_number"
                                value="{{ old('contact_number') }}" class="form-control" placeholder="+91 9876543210">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                class="form-control" placeholder="events@hospital.com">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="url" id="facebook_url" name="facebook_url"
                                    value="{{ old('facebook_url') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="url" id="twitter_url" name="twitter_url"
                                    value="{{ old('twitter_url') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="url" id="instagram_url" name="instagram_url"
                                    value="{{ old('instagram_url') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="url" id="linkedin_url" name="linkedin_url"
                                    value="{{ old('linkedin_url') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="url" id="website_url" name="website_url"
                                    value="{{ old('website_url') }}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="number-input">
                                <input type="number" id="target_participants" name="target_participants"
                                    value="{{ old('target_participants', '100') }}" class="form-control"
                            ...
                            <div class="checkbox-group">
                                <div class="checkbox-item">
                                    <input type="checkbox" id="is_featured" name="is_featured" value="1"
                                        {{ old('is_featured') ? 'checked' : '' }} class="checkbox-input">
                                ...
                                <div class="checkbox-item">
                                    <input type="checkbox" id="is_published" name="is_published" value="1"
                                        {{ old('is_published', true) ? 'checked' : '' }} class="checkbox-input">
                ...
                <div class="form-actions">
                    ...
                    <div class="action-buttons">
                        <a href="{{ route('staff.events.index') }}" class="btn-cancel">
                            Cancel
                        </a>
