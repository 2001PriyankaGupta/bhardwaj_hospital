    ...
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <div class="action-buttons">
                {{-- <a class="btn btn-info mr-2" href="{{ route('staff.appointments.calendar') }}">
                    <i class="fas fa-calendar"></i> Calendar View
                </a> --}}
                <a class="btn btn-primary" href="{{ route('staff.appointments.create') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    ...
                                                    <form action="{{ route('staff.appointments.destroy', $appointment) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.status-select').change(function() {
                ...
                $.ajax({
                    url: `${baseUrl}/staff/appointments/${appointmentId}/status`,
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        status: status
