    ...
    <div class="login-container">
        ...
        <div class="right-section">
            ...
            <div class="alert alert-success" id="successAlert">
                ...
                <span id="successMessage">Password reset link has been sent to your email.</span>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            loginForm.addEventListener('submit', function(e) {
                ...
                simulateLogin(username, password, selectedRole);
            });
            ...
            document.getElementById('forgotPassword').addEventListener('click', function(e) {
                ...
                if (username === '') {
                    showError('Please enter your username to reset password');
                    return;
                }
            ...
            function simulateLogin(username, password, role) {
                ...
                setTimeout(() => {
                    alert(`In a real application, you would be redirected to the ${role} dashboard.`);
                }, 2000);
            }
        });
    </script>
