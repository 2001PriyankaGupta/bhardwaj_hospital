...
@section('content')
    <div class="container-fluid py-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('staff.healthtips.create') }}" class="btn btn-primary d-flex align-items-center gap-2">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-2 pt-2 border-top">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('staff.healthtips.edit', $tip->id) }}"
                                            class="btn btn-warning btn-sm btn-action" style="height: 25px;">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('staff.healthtips.destroy', $tip->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
            ...
            @else
                <div class="col-12">
                    <div class="empty-state py-4">
                        ...
                        <a href="{{ route('staff.healthtips.create') }}" class="btn btn-primary btn-sm">
