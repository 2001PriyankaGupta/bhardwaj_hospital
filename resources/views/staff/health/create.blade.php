...
@section('content')
    <div class="container-fluid py-4">
        <!-- Back Button -->
        {{-- <div class="mb-4">
            <a href="{{ route('staff.healthtips.index') }}" class="btn-back d-inline-flex align-items-center gap-2">
            ...
            <div class="col-lg-12">
                <div class="form-container">
                    ...
                    <div class="form-body">
                        ...
                        <form action="{{ route('staff.healthtips.store') }}" method="POST" enctype="multipart/form-data"
                            id="healthTipForm">
                            @csrf
    ...
    <script>
        ...
        function checkLinkForThumbnail() {
            ...
            if (linkInput.value && !fileInput.files.length) {
                ...
                $.ajax({
                    url: "{{ route('staff.healthtips.fetch-details') }}",
                    method: 'GET',
                    data: {
