                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            ...
                                                            <!-- Delete Button -->
                                                            <form action="{{ route('staff.leaves.destroy', $leave) }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.view-leave', function(e) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Type:</strong> <span class="text-capitalize">${leave.leave_type || 'N/A'}</span></p>
            ...
            $('.approve-leave').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `${baseUrl}/staff/leaves/${leaveId}/status`,
                            method: 'PUT',
                            data: {
                                _token: '{{ csrf_token() }}',
                                status: 'approved'
            ...
            $('#rejectLeaveForm').submit(function(e) {
                ...
                $.ajax({
                    url: `${baseUrl}/staff/leaves/${currentLeaveId}/status`,
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
