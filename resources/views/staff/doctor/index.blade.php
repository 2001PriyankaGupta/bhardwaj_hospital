    ...
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <div class="action-buttons">
                ...
                <a class="btn btn-primary" href="{{ route('staff.doctors.create') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-4 border-0 shadow-sm">
                            <div class="card-body py-3">
                                <form action="{{ route('staff.doctors.index') }}" method="GET" id="filterForm">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group mb-2">
                                                <select name="status" class="form-control form-control-sm"
                                                    ...
                                                    <option value="on_leave"
                                                        {{ request('status') == 'on_leave' ? 'selected' : '' }}>On Leave
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <tr style="font-family: initial;">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center gap-1">
                                                    <!-- View Button -->
                                                    <a href="{{ route('staff.doctors.show', $doctor) }}"
                                                    ...
                                                    <!-- Edit Button -->
                                                    <a href="{{ route('staff.doctors.edit', $doctor) }}"
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form action="{{ route('staff.doctors.destroy', $doctor) }}"
                                                        method="POST" class="d-inline delete-form">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger btn-sm action-btn"
                                                            title="Delete Doctor" data-toggle="tooltip"
                                                            style="height: 25px;" onclick="return confirmDelete(event)">
                                        ...
                                        <tr>
                                            <td colspan="8" class="text-center py-4">
                                                <div class="text-muted">
                                                    ...
                                                    <a href="{{ route('staff.doctors.create') }}"
