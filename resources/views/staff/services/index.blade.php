                                ...
                                @foreach ($packages as $package)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('staff.packages.destroy', $package->id) }}"
                                                method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="action-btn btn-delete"
                                ...
                                @foreach ($discounts as $discount)
                                    <tr data-discount-id="{{ $discount->id }}"
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('staff.discounts.destroy', $discount->id) }}"
                                                method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="action-btn btn-delete"
    ...
    <div class="modal fade" id="serviceModal" tabindex="-1" aria-labelledby="serviceModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('staff.services.store') }}" id="serviceForm">
                    @csrf
    ...
    <div class="modal fade" id="rateCardModal" tabindex="-1" aria-labelledby="rateCardModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('staff.rate-cards.store') }}" id="rateCardForm">
                    @csrf
    ...
    <div class="modal fade" id="packageModal" tabindex="-1" aria-labelledby="packageModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('staff.packages.store') }}" id="packageForm">
                    @csrf
    ...
    <div class="modal fade" id="discountModal" tabindex="-1" aria-labelledby="discountModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('staff.discounts.store') }}" id="discountForm">
                    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        function openServiceModal() {
            ...
            $('#serviceForm').attr('action', '{{ route('staff.services.store') }}');
            $('#serviceId').val('');
            $('#serviceName').val('');
            $('#serviceCategory').val('');
        ...
        function editService(id) {
            ...
            $('#serviceForm').attr('action', '{{ route('staff.services.update', ':id') }}'.replace(':id', id));
        ...
        function openRateCardModal() {
            ...
            $('#rateCardForm').attr('action', '{{ route('staff.rate-cards.store') }}');
            $('#rateCardId').val('');
            $('#rateCardName').val('');
            $('#rateCardService').val('');
        ...
        function editRateCard(id) {
            ...
            $('#rateCardForm').attr('action', `${baseUrl}/staff/rate-cards/${id}`);
        ...
        function openPackageModal() {
            ...
            $('#packageForm').attr('action', '{{ route('staff.packages.store') }}');
            $('#packageId').val('');
            $('#packageName').val('');
            $('#packagePrice').val('');
        ...
        function editPackage(id) {
            ...
            $('#packageForm').attr('action', `${baseUrl}/staff/packages/${id}`);
        ...
        function openDiscountModal() {
            ...
            $('#discountForm').attr('action', '{{ route('staff.discounts.store') }}');
            $('#discountId').val('');
            $('#discountName').val('');
            $('#discountType').val('');
        ...
        function editDiscount(id) {
            ...
            $('#discountForm').attr('action', `${baseUrl}/staff/discounts/${id}`);
