...
@section('title', 'Emergency Triage Management')
    ...
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-center m-4 flex-wrap">
            <div class="d-flex align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-orange fw-bold">Emergency Triage Management</h1>
                ...
                <form method="GET" class="mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="{{ route('staff.emergency.index') }}" class="btn btn-secondary">Reset</a>
                        </div>
                    </div>
                </form>
                                ...
                                <tr
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('staff.emergency.show', $case) }}" class="btn btn-info"
                                                title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            {{-- <a href="{{ route('staff.emergency.edit', $case) }}" class="btn btn-primary"
                                                title="Edit">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.assign-staff-btn').click(function() {
                ...
                form.attr('action', `${baseUrl}/staff/emergency/${caseId}/assign-staff`);
