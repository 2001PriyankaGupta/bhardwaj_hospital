                    ...
                    <div class="card-body">
                        <form action="{{ route('staff.departments.update', $department) }}" method="POST"
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <a href="{{ route('staff.departments.index') }}" class="btn btn-secondary">Cancel</a>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4 border-left-danger">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('staff.departments.destroy', $department) }}" method="POST"
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="{{ route('staff.departments.create') }}" class="btn btn-outline-success btn-sm">
