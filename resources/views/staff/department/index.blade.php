...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('staff.departments.create') }}" class="btn btn-primary btn-sm">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div id="departmentTree">
                            @include('staff.department.partials.tree', ['departments' => $tree])
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{ route('staff.departments.show', $department) }}"
                                                        style="height: 31px;" class="btn btn-info" title="View">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="{{ route('staff.departments.edit', $department) }}"
                                                        style="height: 31px;" class="btn btn-warning" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <form action="{{ route('staff.departments.destroy', $department) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadHierarchyTree() {
                $.get('{{ route('staff.departments.hierarchy-tree') }}', function(data) {
            ...
            function saveHierarchy() {
                ...
                $.post('{{ route('staff.departments.update-hierarchy') }}', {
                    hierarchy: hierarchy,
                    _token: '{{ csrf_token() }}'
                }, function(response) {
                    if (response.success) {
