...
@section('title', 'Apply for Leave - ' . $staff->name)
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-black">
                        <h5 class="card-title mb-0"> Apply for Leave -
                            {{ $staff->name }}
                        </h5>
                    </div>
                    <div class="card-body">
                                ...
                                <form action="{{ route('staff.leaves.store') }}" method="POST" id="leaveForm">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control @error('leave_type') is-invalid @enderror"
                                            ...
                                            <option value="emergency"
                                                {{ old('leave_type') == 'emergency' ? 'selected' : '' }}>Emergency Leave
                                            </option>
                                            <option value="vacation"
                                                {{ old('leave_type') == 'vacation' ? 'selected' : '' }}>Vacation</option>
                                        </select>
                                        @error('leave_type')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('reason') is-invalid @enderror" id="reason" name="reason" rows="5"
                                            placeholder="Please provide detailed reason for your leave application..." required>{{ old('reason') }}</textarea>
                                    ...
                                    <div class="form-group mt-3">
                                        <div class="alert alert-warning">
                                            ...
                                            <ul class="mb-0 mt-2">
                                                <li>Leave applications are subject to approval by the Admin.</li>
                                                <li>Apply at least 3 days in advance for planned leaves.</li>
                                                <li>Emergency leaves should be notified as soon as possible.</li>
                                            </ul>
                                        </div>
                                    </div>
