    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <div class="action-buttons">
                ...
                <a class="btn btn-primary" href="{{ route('staff.room-types.index') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <form method="POST" action="{{ route('staff.rooms.destroy', $room->id) }}"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('addRoomBtn')?.addEventListener('click', function() {
                ...
                roomForm.action = "{{ route('staff.rooms.store') }}";
            });
            ...
            document.querySelectorAll('.edit-room-btn').forEach(button => {
                button.addEventListener('click', function() {
                    const roomData = {
                        ...
                        room_number: this.getAttribute('data-room-number'),
                        room_type_id: this.getAttribute('data-room-type-id'),
                        floor_number: this.getAttribute('data-floor-number'),
                        ward_name: this.getAttribute('data-ward-name'),
                        bed_count: this.getAttribute('data-bed-count'),
                        status: this.getAttribute('data-status'),
                        current_occupancy: this.getAttribute('data-current-occupancy'),
                    ...
                    roomForm.action = `/staff/rooms/${roomData.id}`;
