    ...
    <body class="bg-gray-100">
        <div class="min-h-screen">
            ...
            <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <form id="settingsForm" action="{{ route('staff.settings.update') }}" method="POST">
                    @csrf
                    @method('POST')
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div id="backup" class="settings-section bg-white rounded-lg shadow">
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <form action="{{ route('staff.settings.backup.create') }}" method="POST"
                                            class="flex gap-4">
                                            @csrf
                                            ...
                                            @foreach ($backups as $backup)
                                                <div
                                                    ...
                                                    <div class="flex space-x-2">
                                                        <form
                                                            action="{{ route('staff.settings.backup.restore', $backup->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            <button type="submit"
                            ...
                            <div id="logs" class="settings-section bg-white rounded-lg shadow">
                                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                                    ...
                                    <form action="{{ route('staff.settings.logs.clear') }}" method="POST">
                                        @csrf
                                        <button type="submit"
