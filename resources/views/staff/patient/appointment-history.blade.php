            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('staff.patients.show', $patient) }}" class="btn btn-secondary btn-sm">
        ...
        $(document).ready(function() {
            ...
            $('.view-appointment').click(function() {
                ...
                var html = `
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <strong>Doctor:</strong> ${appointment.doctor.first_name || 'N/A'} ${appointment.doctor.last_name || 'N/A'}
                        </div>
                        <div class="col-md-6">
