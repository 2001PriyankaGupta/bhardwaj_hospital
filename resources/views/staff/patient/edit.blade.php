    ...
    <div class="row mt-4">
        <div class="d-flex justify-content-between align-items-center m-4 flex-wrap">
            <div class="d-flex align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-orange fw-bold">Edit Patient: {{ $patient->first_name }}
                        {{ $patient->last_name }}</h1>
                    <p class="text-muted small mb-0">Update patient information and save changes.</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('staff.patients.update', $patient) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('age') is-invalid @enderror"
                                        id="age" name="age" value="{{ old('age', $patient->user->age ?? '') }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address" rows="3"
                                        placeholder="Full address">{{ old('address', $patient->address) }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('emergency_contact_number', $patient->user->emergency_contact_number ?? '') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('alternate_contact_number', $patient->user->alternate_contact_number ?? '') }}"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('basic_medical_history') is-invalid @enderror" id="basic_medical_history"
                                        ...
                                        placeholder="Enter any relevant medical history, allergies, or conditions">{{ old('basic_medical_history', $patient->user->basic_medical_history ?? $patient->medical_history) }}</textarea>
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <a href="{{ route('staff.patients.show', $patient) }}" class="btn btn-info">
...
@section('scripts')
    ...
    <!-- Optional: Auto-calculate age from date of birth -->
    <script>
