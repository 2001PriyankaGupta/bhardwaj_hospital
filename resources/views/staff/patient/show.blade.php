                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="quick-actions d-flex flex-wrap">
                                        <a href="{{ route('staff.patients.medical-records', $patient) }}"
                                            class="btn btn-outline-primary">
                                            <i class="fas fa-file-medical me-2"></i> Medical Records
                                        </a>
                                        <a href="{{ route('staff.patients.appointment-history', $patient) }}"
                                            ...
                                            <div class="list-group-item">
                                                <div class="d-flex w-100 justify-content-between align-items-start">
                                                    ...
                                                    <small class="text-muted text-end">
                                                        @php
                                                            try {
                                                                // पहले DateTime object check करें
                                                                if ($record->record_date instanceof \DateTime) {
                                                                    echo $record->record_date->format('d M Y');
                                                                } else {
                                                                    // String है तो parse करें
