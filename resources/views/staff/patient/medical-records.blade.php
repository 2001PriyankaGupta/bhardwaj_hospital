                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('staff.patients.store-medical-record', $patient) }}"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($medicalRecords as $record)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('staff.patients.edit-medical-record', $record->id) }}"
                                                        class="btn btn-sm btn-warning">Edit</a>

                                                    <form
                                                        action="{{ route('staff.patients.delete-medical-record', $record->id) }}"
